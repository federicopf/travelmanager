...
serve(async (req) => {
  ...
  try {
    ...
    const mapboxUrl = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodedQuery}.json?access_token=${mapboxToken}&limit=${limit}&language=it&types=country,region,place`;
